...
// ignore_for_file: unused_element, non_constant_identifier_names, no_leading_underscores_for_local_identifiers, camel_case_types, constant_identifier_names

import 'dart:ffi' as ffi;

/// FFI Bindings for NDI Advanced SDK (Android) 5.5.1
class NDIffi {
  ...
  NDIlib_avsync_instance_t NDIlib_avsync_create(
    NDIlib_recv_instance_t p_receiver,
  ) {
    return _NDIlib_avsync_create(
      p_receiver,
    );
  }

  late final _NDIlib_avsync_createPtr =
      _lookup<ffi.NativeFunction<NDIlib_avsync_instance_t Function(NDIlib_recv_instance_t)>>('NDIlib_avsync_create');
  late final _NDIlib_avsync_create =
      _NDIlib_avsync_createPtr.asFunction<NDIlib_avsync_instance_t Function(NDIlib_recv_instance_t)>();

  void NDIlib_avsync_destroy(
    NDIlib_avsync_instance_t p_avsync,
  ) {
    return _NDIlib_avsync_destroy(
      p_avsync,
    );
  }

  late final _NDIlib_avsync_destroyPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_avsync_instance_t)>>('NDIlib_avsync_destroy');
  late final _NDIlib_avsync_destroy = _NDIlib_avsync_destroyPtr.asFunction<void Function(NDIlib_avsync_instance_t)>();

  int NDIlib_avsync_synchronize(
    NDIlib_avsync_instance_t p_avsync,
    ffi.Pointer<NDIlib_video_frame_v2_t> p_video_frame,
    ffi.Pointer<NDIlib_audio_frame_v3_t> p_audio_frame,
  ) {
    return _NDIlib_avsync_synchronize(
      p_avsync,
      p_video_frame,
      p_audio_frame,
    );
  ...
  late final _NDIlib_avsync_synchronizePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(NDIlib_avsync_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>,
              ffi.Pointer<NDIlib_audio_frame_v3_t>)>>('NDIlib_avsync_synchronize');
  late final _NDIlib_avsync_synchronize = _NDIlib_avsync_synchronizePtr.asFunction<
      int Function(
          NDIlib_avsync_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>, ffi.Pointer<NDIlib_audio_frame_v3_t>)>();

  void NDIlib_avsync_free_audio(
    NDIlib_avsync_instance_t p_avsync,
    ffi.Pointer<NDIlib_audio_frame_v3_t> p_audio_frame,
  ) {
    return _NDIlib_avsync_free_audio(
      p_avsync,
      p_audio_frame,
    );
  }

  late final _NDIlib_avsync_free_audioPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_avsync_instance_t, ffi.Pointer<NDIlib_audio_frame_v3_t>)>>(
          'NDIlib_avsync_free_audio');
  late final _NDIlib_avsync_free_audio = _NDIlib_avsync_free_audioPtr.asFunction<
      void Function(NDIlib_avsync_instance_t, ffi.Pointer<NDIlib_audio_frame_v3_t>)>();

  NDIlib_genlock_instance_t NDIlib_genlock_create(
    ffi.Pointer<NDIlib_source_t> p_src_settings,
    ffi.Pointer<ffi.Char> p_config_data,
  ) {
    return _NDIlib_genlock_create(
      p_src_settings,
      p_config_data,
    );
  }

  late final _NDIlib_genlock_createPtr = _lookup<
          ffi.NativeFunction<NDIlib_genlock_instance_t Function(ffi.Pointer<NDIlib_source_t>, ffi.Pointer<ffi.Char>)>>(
      'NDIlib_genlock_create');
  late final _NDIlib_genlock_create = _NDIlib_genlock_createPtr.asFunction<
      NDIlib_genlock_instance_t Function(ffi.Pointer<NDIlib_source_t>, ffi.Pointer<ffi.Char>)>();

  void NDIlib_genlock_destroy(
    NDIlib_genlock_instance_t p_instance,
  ) {
    return _NDIlib_genlock_destroy(
      p_instance,
    );
  }

  late final _NDIlib_genlock_destroyPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_genlock_instance_t)>>('NDIlib_genlock_destroy');
  late final _NDIlib_genlock_destroy =
      _NDIlib_genlock_destroyPtr.asFunction<void Function(NDIlib_genlock_instance_t)>();

  void NDIlib_genlock_connect(
    NDIlib_genlock_instance_t p_instance,
    ffi.Pointer<NDIlib_source_t> p_src_settings,
  ) {
    return _NDIlib_genlock_connect(
      p_instance,
      p_src_settings,
    );
  }

  late final _NDIlib_genlock_connectPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_genlock_instance_t, ffi.Pointer<NDIlib_source_t>)>>(
          'NDIlib_genlock_connect');
  late final _NDIlib_genlock_connect =
      _NDIlib_genlock_connectPtr.asFunction<void Function(NDIlib_genlock_instance_t, ffi.Pointer<NDIlib_source_t>)>();

  bool NDIlib_genlock_is_active(
    NDIlib_genlock_instance_t p_instance,
  ) {
    return _NDIlib_genlock_is_active(
      p_instance,
    );
  }

  late final _NDIlib_genlock_is_activePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_genlock_instance_t)>>('NDIlib_genlock_is_active');
  late final _NDIlib_genlock_is_active =
      _NDIlib_genlock_is_activePtr.asFunction<bool Function(NDIlib_genlock_instance_t)>();

  bool NDIlib_genlock_wait_video(
    NDIlib_genlock_instance_t p_instance,
    ffi.Pointer<NDIlib_video_frame_v2_t> p_video_data,
  ) {
    return _NDIlib_genlock_wait_video(
      p_instance,
      p_video_data,
    );
  }

  late final _NDIlib_genlock_wait_videoPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_genlock_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>>(
          'NDIlib_genlock_wait_video');
  late final _NDIlib_genlock_wait_video = _NDIlib_genlock_wait_videoPtr.asFunction<
      bool Function(NDIlib_genlock_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>();

  bool NDIlib_genlock_wait_audio(
    NDIlib_genlock_instance_t p_instance,
    ffi.Pointer<NDIlib_audio_frame_v3_t> p_audio_data,
  ) {
    return _NDIlib_genlock_wait_audio(
      p_instance,
      p_audio_data,
    );
  }

  late final _NDIlib_genlock_wait_audioPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_genlock_instance_t, ffi.Pointer<NDIlib_audio_frame_v3_t>)>>(
          'NDIlib_genlock_wait_audio');
  late final _NDIlib_genlock_wait_audio = _NDIlib_genlock_wait_audioPtr.asFunction<
      bool Function(NDIlib_genlock_instance_t, ffi.Pointer<NDIlib_audio_frame_v3_t>)>();

  bool NDIlib_recv_kvm_is_supported(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_is_supported(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_is_supportedPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>('NDIlib_recv_kvm_is_supported');
  late final _NDIlib_recv_kvm_is_supported =
      _NDIlib_recv_kvm_is_supportedPtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_left_mouse_click(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_left_mouse_click(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_left_mouse_clickPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>('NDIlib_recv_kvm_send_left_mouse_click');
  late final _NDIlib_recv_kvm_send_left_mouse_click =
      _NDIlib_recv_kvm_send_left_mouse_clickPtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_middle_mouse_click(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_middle_mouse_click(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_middle_mouse_clickPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>('NDIlib_recv_kvm_send_middle_mouse_click');
  late final _NDIlib_recv_kvm_send_middle_mouse_click =
      _NDIlib_recv_kvm_send_middle_mouse_clickPtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_right_mouse_click(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_right_mouse_click(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_right_mouse_clickPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>('NDIlib_recv_kvm_send_right_mouse_click');
  late final _NDIlib_recv_kvm_send_right_mouse_click =
      _NDIlib_recv_kvm_send_right_mouse_clickPtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_left_mouse_release(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_left_mouse_release(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_left_mouse_releasePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>('NDIlib_recv_kvm_send_left_mouse_release');
  late final _NDIlib_recv_kvm_send_left_mouse_release =
      _NDIlib_recv_kvm_send_left_mouse_releasePtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_middle_mouse_release(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_middle_mouse_release(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_middle_mouse_releasePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>(
          'NDIlib_recv_kvm_send_middle_mouse_release');
  late final _NDIlib_recv_kvm_send_middle_mouse_release =
      _NDIlib_recv_kvm_send_middle_mouse_releasePtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_right_mouse_release(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_right_mouse_release(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_right_mouse_releasePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>(
          'NDIlib_recv_kvm_send_right_mouse_release');
  late final _NDIlib_recv_kvm_send_right_mouse_release =
      _NDIlib_recv_kvm_send_right_mouse_releasePtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_vertical_mouse_wheel(
    NDIlib_recv_instance_t p_instance,
    double no_units,
  ) {
    return _NDIlib_recv_kvm_send_vertical_mouse_wheel(
      p_instance,
      no_units,
    );
  }

  late final _NDIlib_recv_kvm_send_vertical_mouse_wheelPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Float)>>(
          'NDIlib_recv_kvm_send_vertical_mouse_wheel');
  late final _NDIlib_recv_kvm_send_vertical_mouse_wheel =
      _NDIlib_recv_kvm_send_vertical_mouse_wheelPtr.asFunction<bool Function(NDIlib_recv_instance_t, double)>();

  bool NDIlib_recv_kvm_send_horizontal_mouse_wheel(
    NDIlib_recv_instance_t p_instance,
    double no_units,
  ) {
    return _NDIlib_recv_kvm_send_horizontal_mouse_wheel(
      p_instance,
      no_units,
    );
  }

  late final _NDIlib_recv_kvm_send_horizontal_mouse_wheelPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Float)>>(
          'NDIlib_recv_kvm_send_horizontal_mouse_wheel');
  late final _NDIlib_recv_kvm_send_horizontal_mouse_wheel =
      _NDIlib_recv_kvm_send_horizontal_mouse_wheelPtr.asFunction<bool Function(NDIlib_recv_instance_t, double)>();

  bool NDIlib_recv_kvm_send_mouse_position(
    NDIlib_recv_instance_t p_instance,
    ffi.Pointer<ffi.Float> posn,
  ) {
    return _NDIlib_recv_kvm_send_mouse_position(
      p_instance,
      posn,
    );
  }

  late final _NDIlib_recv_kvm_send_mouse_positionPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Float>)>>(
          'NDIlib_recv_kvm_send_mouse_position');
  late final _NDIlib_recv_kvm_send_mouse_position = _NDIlib_recv_kvm_send_mouse_positionPtr.asFunction<
      bool Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Float>)>();

  bool NDIlib_recv_kvm_send_clipboard_contents(
    NDIlib_recv_instance_t p_instance,
    ffi.Pointer<ffi.Char> p_clipboard_contents,
  ) {
    return _NDIlib_recv_kvm_send_clipboard_contents(
      p_instance,
      p_clipboard_contents,
    );
  }

  late final _NDIlib_recv_kvm_send_clipboard_contentsPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Char>)>>(
          'NDIlib_recv_kvm_send_clipboard_contents');
  late final _NDIlib_recv_kvm_send_clipboard_contents = _NDIlib_recv_kvm_send_clipboard_contentsPtr.asFunction<
      bool Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Char>)>();

  bool NDIlib_recv_kvm_send_touch_positions(
    NDIlib_recv_instance_t p_instance,
    int no_posns,
    ffi.Pointer<ffi.Float> posns,
  ) {
    return _NDIlib_recv_kvm_send_touch_positions(
      p_instance,
      no_posns,
      posns,
    );
  ...
  late final _NDIlib_recv_kvm_send_touch_positionsPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Int, ffi.Pointer<ffi.Float>)>>(
          'NDIlib_recv_kvm_send_touch_positions');
  late final _NDIlib_recv_kvm_send_touch_positions = _NDIlib_recv_kvm_send_touch_positionsPtr.asFunction<
      bool Function(NDIlib_recv_instance_t, int, ffi.Pointer<ffi.Float>)>();

  bool NDIlib_recv_kvm_send_touch_finish(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_kvm_send_touch_finish(
      p_instance,
    );
  }

  late final _NDIlib_recv_kvm_send_touch_finishPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t)>>('NDIlib_recv_kvm_send_touch_finish');
  late final _NDIlib_recv_kvm_send_touch_finish =
      _NDIlib_recv_kvm_send_touch_finishPtr.asFunction<bool Function(NDIlib_recv_instance_t)>();

  bool NDIlib_recv_kvm_send_keyboard_press(
    NDIlib_recv_instance_t p_instance,
    int key_sym_value,
  ) {
    return _NDIlib_recv_kvm_send_keyboard_press(
      p_instance,
      key_sym_value,
    );
  }

  late final _NDIlib_recv_kvm_send_keyboard_pressPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Int)>>(
          'NDIlib_recv_kvm_send_keyboard_press');
  late final _NDIlib_recv_kvm_send_keyboard_press =
      _NDIlib_recv_kvm_send_keyboard_pressPtr.asFunction<bool Function(NDIlib_recv_instance_t, int)>();

  bool NDIlib_recv_kvm_send_keyboard_release(
    NDIlib_recv_instance_t p_instance,
    int key_sym_value,
  ) {
    return _NDIlib_recv_kvm_send_keyboard_release(
      p_instance,
      key_sym_value,
    );
  }

  late final _NDIlib_recv_kvm_send_keyboard_releasePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_recv_instance_t, ffi.Int)>>(
          'NDIlib_recv_kvm_send_keyboard_release');
  late final _NDIlib_recv_kvm_send_keyboard_release =
      _NDIlib_recv_kvm_send_keyboard_releasePtr.asFunction<bool Function(NDIlib_recv_instance_t, int)>();

  late final ffi.Pointer<ffi.Uint32> _NDIlib_compressed_packet_flags_none =
      _lookup<ffi.Uint32>('NDIlib_compressed_packet_flags_none');

  int get NDIlib_compressed_packet_flags_none => _NDIlib_compressed_packet_flags_none.value;

  set NDIlib_compressed_packet_flags_none(int value) => _NDIlib_compressed_packet_flags_none.value = value;

  late final ffi.Pointer<ffi.Uint32> _NDIlib_compressed_packet_flags_keyframe =
      _lookup<ffi.Uint32>('NDIlib_compressed_packet_flags_keyframe');

  int get NDIlib_compressed_packet_flags_keyframe => _NDIlib_compressed_packet_flags_keyframe.value;

  set NDIlib_compressed_packet_flags_keyframe(int value) => _NDIlib_compressed_packet_flags_keyframe.value = value;

  late final ffi.Pointer<ffi.Int32> _NDIlib_compressed_packet_version_0 =
      _lookup<ffi.Int32>('NDIlib_compressed_packet_version_0');

  int get NDIlib_compressed_packet_version_0 => _NDIlib_compressed_packet_version_0.value;

  set NDIlib_compressed_packet_version_0(int value) => _NDIlib_compressed_packet_version_0.value = value;

  int NDIlib_send_get_target_frame_size(
    NDIlib_send_instance_t p_instance,
    ffi.Pointer<NDIlib_video_frame_v2_t> p_video_data,
  ) {
    return _NDIlib_send_get_target_frame_size(
      p_instance,
      p_video_data,
    );
  }

  late final _NDIlib_send_get_target_frame_sizePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>>(
          'NDIlib_send_get_target_frame_size');
  late final _NDIlib_send_get_target_frame_size = _NDIlib_send_get_target_frame_sizePtr.asFunction<
      int Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>();

  int NDIlib_send_get_target_bit_rate(
    NDIlib_send_instance_t p_instance,
    ffi.Pointer<NDIlib_video_frame_v2_t> p_video_data,
  ) {
    return _NDIlib_send_get_target_bit_rate(
      p_instance,
      p_video_data,
    );
  }

  late final _NDIlib_send_get_target_bit_ratePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>>(
          'NDIlib_send_get_target_bit_rate');
  late final _NDIlib_send_get_target_bit_rate = _NDIlib_send_get_target_bit_ratePtr.asFunction<
      int Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>();

  int NDIlib_send_get_q_factor(
    NDIlib_send_instance_t p_instance,
    ffi.Pointer<NDIlib_video_frame_v2_t> p_video_data,
  ) {
    return _NDIlib_send_get_q_factor(
      p_instance,
      p_video_data,
    );
  }

  late final _NDIlib_send_get_q_factorPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>>(
          'NDIlib_send_get_q_factor');
  late final _NDIlib_send_get_q_factor = _NDIlib_send_get_q_factorPtr.asFunction<
      int Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>();
  ...
  bool NDIlib_send_is_keyframe_required(
    ...
    return _NDIlib_send_is_keyframe_required(
      p_instance,
      p_video_data,
    );
  }

  late final _NDIlib_send_is_keyframe_requiredPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>>(
          'NDIlib_send_is_keyframe_required');
  late final _NDIlib_send_is_keyframe_required = _NDIlib_send_is_keyframe_requiredPtr.asFunction<
      bool Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>)>();
  ...
  bool NDIlib_send_wait_for_keyframe_request(
    ...
    return _NDIlib_send_wait_for_keyframe_request(
      p_instance,
      timeout_in_ms,
      p_video_data,
    );
  ...
  late final _NDIlib_send_wait_for_keyframe_requestPtr = _lookup<
      ffi.NativeFunction<
          ffi.Bool Function(NDIlib_send_instance_t, ffi.Uint32,
              ffi.Pointer<NDIlib_video_frame_v2_t>)>>('NDIlib_send_wait_for_keyframe_request');
  late final _NDIlib_send_wait_for_keyframe_request = _NDIlib_send_wait_for_keyframe_requestPtr.asFunction<
      bool Function(NDIlib_send_instance_t, int, ffi.Pointer<NDIlib_video_frame_v2_t>)>();

  void NDIlib_recv_request_keyframe(
    NDIlib_recv_instance_t p_instance,
  ) {
    return _NDIlib_recv_request_keyframe(
      p_instance,
    );
  }

  late final _NDIlib_recv_request_keyframePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_recv_instance_t)>>('NDIlib_recv_request_keyframe');
  late final _NDIlib_recv_request_keyframe =
      _NDIlib_recv_request_keyframePtr.asFunction<void Function(NDIlib_recv_instance_t)>();

  void NDIlib_send_send_video_scatter(
    NDIlib_send_instance_t p_instance,
    ffi.Pointer<NDIlib_video_frame_v2_t> p_video_data,
    ffi.Pointer<NDIlib_frame_scatter_t> p_video_scatter,
  ) {
    return _NDIlib_send_send_video_scatter(
      p_instance,
      p_video_data,
      p_video_scatter,
    );
  ...
  late final _NDIlib_send_send_video_scatterPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>,
              ffi.Pointer<NDIlib_frame_scatter_t>)>>('NDIlib_send_send_video_scatter');
  late final _NDIlib_send_send_video_scatter = _NDIlib_send_send_video_scatterPtr.asFunction<
      void Function(
          NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>, ffi.Pointer<NDIlib_frame_scatter_t>)>();
  ...
  void NDIlib_send_send_video_scatter_async(
    ...
    return _NDIlib_send_send_video_scatter_async(
      p_instance,
      p_video_data,
      p_video_scatter,
    );
  ...
  late final _NDIlib_send_send_video_scatter_asyncPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>,
              ffi.Pointer<NDIlib_frame_scatter_t>)>>('NDIlib_send_send_video_scatter_async');
  late final _NDIlib_send_send_video_scatter_async = _NDIlib_send_send_video_scatter_asyncPtr.asFunction<
      void Function(
          NDIlib_send_instance_t, ffi.Pointer<NDIlib_video_frame_v2_t>, ffi.Pointer<NDIlib_frame_scatter_t>)>();
  ...
  void NDIlib_send_send_audio_scatter(
    NDIlib_send_instance_t p_instance,
    ffi.Pointer<NDIlib_audio_frame_v3_t> p_audio_data,
    ffi.Pointer<NDIlib_frame_scatter_t> p_audio_scatter,
  ) {
    return _NDIlib_send_send_audio_scatter(
      p_instance,
      p_audio_data,
      p_audio_scatter,
    );
  ...
  late final _NDIlib_send_send_audio_scatterPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_audio_frame_v3_t>,
              ffi.Pointer<NDIlib_frame_scatter_t>)>>('NDIlib_send_send_audio_scatter');
  late final _NDIlib_send_send_audio_scatter = _NDIlib_send_send_audio_scatterPtr.asFunction<
      void Function(
          NDIlib_send_instance_t, ffi.Pointer<NDIlib_audio_frame_v3_t>, ffi.Pointer<NDIlib_frame_scatter_t>)>();

  bool NDIlib_send_set_tally(
    NDIlib_send_instance_t p_instance,
    ffi.Pointer<NDIlib_tally_t> p_tally,
  ) {
    return _NDIlib_send_set_tally(
      p_instance,
      p_tally,
    );
  }

  late final _NDIlib_send_set_tallyPtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_tally_t>)>>(
          'NDIlib_send_set_tally');
  late final _NDIlib_send_set_tally =
      _NDIlib_send_set_tallyPtr.asFunction<bool Function(NDIlib_send_instance_t, ffi.Pointer<NDIlib_tally_t>)>();

  void NDIlib_routing_add_connection_metadata(
    NDIlib_routing_instance_t p_instance,
    ffi.Pointer<NDIlib_metadata_frame_t> p_metadata,
  ) {
    return _NDIlib_routing_add_connection_metadata(
      p_instance,
      p_metadata,
    );
  }

  late final _NDIlib_routing_add_connection_metadataPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_routing_instance_t, ffi.Pointer<NDIlib_metadata_frame_t>)>>(
          'NDIlib_routing_add_connection_metadata');
  late final _NDIlib_routing_add_connection_metadata = _NDIlib_routing_add_connection_metadataPtr.asFunction<
      void Function(NDIlib_routing_instance_t, ffi.Pointer<NDIlib_metadata_frame_t>)>();

  void NDIlib_routing_clear_connection_metadata(
    NDIlib_routing_instance_t p_instance,
  ) {
    return _NDIlib_routing_clear_connection_metadata(
      p_instance,
    );
  }

  late final _NDIlib_routing_clear_connection_metadataPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(NDIlib_routing_instance_t)>>(
          'NDIlib_routing_clear_connection_metadata');
  late final _NDIlib_routing_clear_connection_metadata =
      _NDIlib_routing_clear_connection_metadataPtr.asFunction<void Function(NDIlib_routing_instance_t)>();

  NDIlib_find_instance_t NDIlib_find_create_v3(
    ffi.Pointer<NDIlib_find_create_t> p_create_settings,
    ffi.Pointer<ffi.Char> p_config_data,
  ) {
    return _NDIlib_find_create_v3(
      p_create_settings,
      p_config_data,
    );
  }

  late final _NDIlib_find_create_v3Ptr = _lookup<
      ffi.NativeFunction<
          NDIlib_find_instance_t Function(
              ffi.Pointer<NDIlib_find_create_t>, ffi.Pointer<ffi.Char>)>>('NDIlib_find_create_v3');
  late final _NDIlib_find_create_v3 = _NDIlib_find_create_v3Ptr.asFunction<
      NDIlib_find_instance_t Function(ffi.Pointer<NDIlib_find_create_t>, ffi.Pointer<ffi.Char>)>();

  NDIlib_recv_instance_t NDIlib_recv_create_v4(
    ffi.Pointer<NDIlib_recv_create_v3_t> p_create_settings,
    ffi.Pointer<ffi.Char> p_config_data,
  ) {
    return _NDIlib_recv_create_v4(
      p_create_settings,
      p_config_data,
    );
  }

  late final _NDIlib_recv_create_v4Ptr = _lookup<
      ffi.NativeFunction<
          NDIlib_recv_instance_t Function(
              ffi.Pointer<NDIlib_recv_create_v3_t>, ffi.Pointer<ffi.Char>)>>('NDIlib_recv_create_v4');
  late final _NDIlib_recv_create_v4 = _NDIlib_recv_create_v4Ptr.asFunction<
      NDIlib_recv_instance_t Function(ffi.Pointer<NDIlib_recv_create_v3_t>, ffi.Pointer<ffi.Char>)>();

  NDIlib_send_instance_t NDIlib_send_create_v2(
    ffi.Pointer<NDIlib_send_create_t> p_create_settings,
    ffi.Pointer<ffi.Char> p_config_data,
  ) {
    return _NDIlib_send_create_v2(
      p_create_settings,
      p_config_data,
    );
  }

  late final _NDIlib_send_create_v2Ptr = _lookup<
      ffi.NativeFunction<
          NDIlib_send_instance_t Function(
              ffi.Pointer<NDIlib_send_create_t>, ffi.Pointer<ffi.Char>)>>('NDIlib_send_create_v2');
  late final _NDIlib_send_create_v2 = _NDIlib_send_create_v2Ptr.asFunction<
      NDIlib_send_instance_t Function(ffi.Pointer<NDIlib_send_create_t>, ffi.Pointer<ffi.Char>)>();

  NDIlib_routing_instance_t NDIlib_routing_create_v2(
    ffi.Pointer<NDIlib_routing_create_t> p_create_settings,
    ffi.Pointer<ffi.Char> p_config_data,
  ) {
    return _NDIlib_routing_create_v2(
      p_create_settings,
      p_config_data,
    );
  }

  late final _NDIlib_routing_create_v2Ptr = _lookup<
      ffi.NativeFunction<
          NDIlib_routing_instance_t Function(
              ffi.Pointer<NDIlib_routing_create_t>, ffi.Pointer<ffi.Char>)>>('NDIlib_routing_create_v2');
  late final _NDIlib_routing_create_v2 = _NDIlib_routing_create_v2Ptr.asFunction<
      NDIlib_routing_instance_t Function(ffi.Pointer<NDIlib_routing_create_t>, ffi.Pointer<ffi.Char>)>();

  void NDIlib_recv_set_video_allocator(
    NDIlib_recv_instance_t p_instance,
    ffi.Pointer<ffi.Void> p_opaque,
    NDIlib_video_alloc_t p_allocator,
    NDIlib_video_free_t p_deallocator,
  ) {
    return _NDIlib_recv_set_video_allocator(
      p_instance,
      p_opaque,
      p_allocator,
      p_deallocator,
  ...
  late final _NDIlib_recv_set_video_allocatorPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Void>, NDIlib_video_alloc_t,
              NDIlib_video_free_t)>>('NDIlib_recv_set_video_allocator');
  late final _NDIlib_recv_set_video_allocator = _NDIlib_recv_set_video_allocatorPtr.asFunction<
      void Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Void>, NDIlib_video_alloc_t, NDIlib_video_free_t)>();

  void NDIlib_recv_set_audio_allocator(
    NDIlib_recv_instance_t p_instance,
    ffi.Pointer<ffi.Void> p_opaque,
    NDIlib_audio_alloc_t p_allocator,
    NDIlib_audio_free_t p_deallocator,
  ) {
    return _NDIlib_recv_set_audio_allocator(
      p_instance,
      p_opaque,
      p_allocator,
      p_deallocator,
  ...
  late final _NDIlib_recv_set_audio_allocatorPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Void>, NDIlib_audio_alloc_t,
              NDIlib_audio_free_t)>>('NDIlib_recv_set_audio_allocator');
  late final _NDIlib_recv_set_audio_allocator = _NDIlib_recv_set_audio_allocatorPtr.asFunction<
      void Function(NDIlib_recv_instance_t, ffi.Pointer<ffi.Void>, NDIlib_audio_alloc_t, NDIlib_audio_free_t)>();
  ...
  void NDIlib_send_set_video_async_completion(
    ...
    return _NDIlib_send_set_video_async_completion(
      p_instance,
      p_opaque,
      p_deallocator,
    );
  ...
  late final _NDIlib_send_set_video_async_completionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(NDIlib_send_instance_t, ffi.Pointer<ffi.Void>,
              NDIlib_video_send_async_completion_t)>>('NDIlib_send_set_video_async_completion');
  late final _NDIlib_send_set_video_async_completion = _NDIlib_send_set_video_async_completionPtr.asFunction<
      void Function(NDIlib_send_instance_t, ffi.Pointer<ffi.Void>, NDIlib_video_send_async_completion_t)>();

  ffi.Pointer<NDIlib_source_v2_t> NDIlib_find_get_current_sources_v2(
    NDIlib_find_instance_t p_instance,
    ffi.Pointer<ffi.Uint32> p_no_sources,
  ) {
    return _NDIlib_find_get_current_sources_v2(
      p_instance,
      p_no_sources,
    );
  }

  late final _NDIlib_find_get_current_sources_v2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<NDIlib_source_v2_t> Function(
              NDIlib_find_instance_t, ffi.Pointer<ffi.Uint32>)>>('NDIlib_find_get_current_sources_v2');
  late final _NDIlib_find_get_current_sources_v2 = _NDIlib_find_get_current_sources_v2Ptr.asFunction<
      ffi.Pointer<NDIlib_source_v2_t> Function(NDIlib_find_instance_t, ffi.Pointer<ffi.Uint32>)>();
}
...
class NDIlib_avsync_instance_type extends ffi.Opaque {}

typedef NDIlib_avsync_instance_t = ffi.Pointer<NDIlib_avsync_instance_type>;

abstract class NDIlib_avsync_ret_e {
  static const int NDIlib_avsync_ret_success = 1;
  static const int NDIlib_avsync_ret_success_num_samples_not_matched = 2;
  static const int NDIlib_avsync_ret_no_audio_stream_received = -1;
  static const int NDIlib_avsync_ret_no_samples_found = -2;
  static const int NDIlib_avsync_ret_format_changed = -3;
  static const int NDIlib_avsync_ret_internal_error = -4;
}

class NDIlib_genlock_instance_type extends ffi.Opaque {}

typedef NDIlib_genlock_instance_t = ffi.Pointer<NDIlib_genlock_instance_type>;

abstract class NDIlib_FourCC_video_type_ex_e {
  static const int NDIlib_FourCC_video_type_ex_SHQ0_highest_bandwidth = 810633299;
  static const int NDIlib_FourCC_type_SHQ0_highest_bandwidth = 810633299;
  static const int NDIlib_FourCC_video_type_ex_SHQ2_highest_bandwidth = 844187731;
  static const int NDIlib_FourCC_type_SHQ2_highest_bandwidth = 844187731;
  static const int NDIlib_FourCC_video_type_ex_SHQ7_highest_bandwidth = 928073811;
  static const int NDIlib_FourCC_type_SHQ7_highest_bandwidth = 928073811;
  static const int NDIlib_FourCC_video_type_ex_SHQ0_lowest_bandwidth = 812738675;
  static const int NDIlib_FourCC_type_SHQ0_lowest_bandwidth = 812738675;
  static const int NDIlib_FourCC_video_type_ex_SHQ2_lowest_bandwidth = 846293107;
  static const int NDIlib_FourCC_type_SHQ2_lowest_bandwidth = 846293107;
  static const int NDIlib_FourCC_video_type_ex_SHQ7_lowest_bandwidth = 930179187;
  static const int NDIlib_FourCC_type_SHQ7_lowest_bandwidth = 930179187;
  static const int NDIlib_FourCC_video_type_ex_H264_highest_bandwidth = 875967048;
  static const int NDIlib_FourCC_type_H264_highest_bandwidth = 875967048;
  static const int NDIlib_FourCC_video_type_ex_H264_lowest_bandwidth = 875967080;
  static const int NDIlib_FourCC_type_H264_lowest_bandwidth = 875967080;
  static const int NDIlib_FourCC_video_type_ex_HEVC_highest_bandwidth = 1129727304;
  static const int NDIlib_FourCC_type_HEVC_highest_bandwidth = 1129727304;
  static const int NDIlib_FourCC_video_type_ex_HEVC_lowest_bandwidth = 1668703592;
  static const int NDIlib_FourCC_type_HEVC_lowest_bandwidth = 1668703592;
  static const int NDIlib_FourCC_video_type_ex_H264_alpha_highest_bandwidth = 875967041;
  static const int NDIlib_FourCC_type_h264_alpha_highest_bandwidth = 875967041;
  static const int NDIlib_FourCC_video_type_ex_H264_alpha_lowest_bandwidth = 875967073;
  static const int NDIlib_FourCC_type_h264_alpha_lowest_bandwidth = 875967073;
  static const int NDIlib_FourCC_video_type_ex_HEVC_alpha_highest_bandwidth = 1129727297;
  static const int NDIlib_FourCC_type_HEVC_alpha_highest_bandwidth = 1129727297;
  static const int NDIlib_FourCC_video_type_ex_HEVC_alpha_lowest_bandwidth = 1668703585;
  static const int NDIlib_FourCC_type_HEVC_alpha_lowest_bandwidth = 1668703585;
  static const int NDIlib_FourCC_video_type_ex_max = 2147483647;
}

abstract class NDIlib_FourCC_audio_type_ex_e {
  static const int NDIlib_FourCC_audio_type_ex_AAC = 255;
  static const int NDIlib_FourCC_audio_type_ex_OPUS = 1937076303;
  static const int NDIlib_FourCC_audio_type_ex_max = 2147483647;
}

abstract class NDIlib_compressed_FourCC_type_e {
  static const int NDIlib_compressed_FourCC_type_H264 = 875967048;
  static const int NDIlib_FourCC_type_H264 = 875967048;
  static const int NDIlib_compressed_FourCC_type_HEVC = 1129727304;
  static const int NDIlib_FourCC_type_HEVC = 1129727304;
  static const int NDIlib_compressed_FourCC_type_AAC = 255;
  static const int NDIlib_FourCC_type_AAC = 255;
  static const int NDIlib_compressed_FourCC_type_max = 2147483647;
}

abstract class NDIlib_recv_color_format_ex_e {
  static const int NDIlib_recv_color_format_ex_compressed = 300;
  static const int NDIlib_recv_color_format_compressed = 300;
  static const int NDIlib_recv_color_format_ex_compressed_v1 = 300;
  static const int NDIlib_recv_color_format_compressed_v1 = 300;
  static const int NDIlib_recv_color_format_ex_compressed_v2 = 301;
  static const int NDIlib_recv_color_format_compressed_v2 = 301;
  static const int NDIlib_recv_color_format_ex_compressed_v3 = 302;
  static const int NDIlib_recv_color_format_compressed_v3 = 302;
  static const int NDIlib_recv_color_format_ex_compressed_v3_with_audio = 304;
  static const int NDIlib_recv_color_format_compressed_v3_with_audio = 304;
  static const int NDIlib_recv_color_format_ex_compressed_v4 = 303;
  static const int NDIlib_recv_color_format_compressed_v4 = 303;
  static const int NDIlib_recv_color_format_ex_compressed_v4_with_audio = 305;
  static const int NDIlib_recv_color_format_compressed_v4_with_audio = 305;
  static const int NDIlib_recv_color_format_ex_compressed_v5 = 307;
  static const int NDIlib_recv_color_format_compressed_v5 = 307;
  static const int NDIlib_recv_color_format_ex_compressed_v5_with_audio = 308;
  static const int NDIlib_recv_color_format_compressed_v5_with_audio = 308;
  static const int NDIlib_recv_color_format_ex_max = 2147483647;
}

@ffi.Packed(1)
class NDIlib_compressed_packet_t extends ffi.Struct {
  @ffi.Int32()
...
class NDIlib_frame_scatter_t extends ffi.Struct {
  external ffi.Pointer<ffi.Pointer<ffi.Uint8>> p_data_blocks;

  external ffi.Pointer<ffi.Int> p_data_blocks_size;
}

typedef NDIlib_video_alloc_t
    = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>, ffi.Pointer<NDIlib_video_frame_v2_t>)>>;
typedef NDIlib_video_free_t
    = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>, ffi.Pointer<NDIlib_video_frame_v2_t>)>>;
typedef NDIlib_audio_alloc_t
    = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>, ffi.Pointer<NDIlib_audio_frame_v3_t>)>>;
typedef NDIlib_audio_free_t
    = ffi.Pointer<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Void>, ffi.Pointer<NDIlib_audio_frame_v3_t>)>>;
typedef NDIlib_video_send_async_completion_t
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void>, ffi.Pointer<NDIlib_video_frame_v2_t>)>>;

class NDIlib_source_v2_t extends ffi.Struct {
  external ffi.Pointer<ffi.Char> p_ndi_name;
